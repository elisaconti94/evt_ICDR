...
<xsl:stylesheet xpath-default-namespace="http://www.tei-c.org/ns/1.0"
	...
	<xsl:param name="index_title" select="'I Capricci di un Re'"/>
	...
	<xsl:param name="welcomeMsg">
		<div>
			<p class="title main">Benvenuti nell'edizione EVT de I Capricci d'un Re</p>
		</div>
		<div>Il progetto è stato creato da Elisa Conti nel contesto del Master Infotext dell'Università degli studi di Siena.</div>
		<div>Si consiglia di passare alla modalità a schermo intero in modo da visualizzare le scansioni e il testo della trascrizione su uno spazio più ampio.
			</div>
		<div>Per ulteriori informazioni riguardo al progetto o eventuali segnalazioni contattateci all'indirizzo: <a href="mailto:operestefanopulvirenti@gmail.com">operestefanopulvirenti@gmail.com</a></div>
	</xsl:param>
	...
	<xsl:param name="evtTxt">
		<p>EVT (Edition Visualization Technology)</p>
