...
<xsl:stylesheet xpath-default-namespace="http://www.tei-c.org/ns/1.0"
	...
	<!-- default: '' -->
	<xsl:param name="webSite" select="'http://www.tei-c.org/release/doc/tei-p5-doc/it/html/PH.html#PHZLAB'"/>
	
	<!-- EN: Index title -->
	<!-- IT: Titolo edizione -->
	<!-- default: 'Codex Viewer' -->
	<xsl:param name="index_title" select="'TEI Embedded Transcription'"/>
	...
	<xsl:param name="welcomeMsg">
		...
		<div>This is the result of some small examples of 
			<a href="http://www.tei-c.org/release/doc/tei-p5-doc/it/html/PH.html#PHZLAB" target="_blank">TEI Embedded Transcription</a>.</div>
	...
	<xsl:param name="viscoll_scheme_path"></xsl:param>
	...
	<!-- IT: Percorso al file xml contenente la lista delle immagini necessaria al corretto funzionamento di viscoll.
		...
		Altrimenti copiare il file nella cartella data/input_data/text e inserire qui solo percorso relativo a partire da quella cartella. -->
	<xsl:param name="viscoll_image_list_path"></xsl:param>
